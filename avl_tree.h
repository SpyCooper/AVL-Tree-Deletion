...
private:
  ...
  //functions I added:
  void printData(AVLNode* &root); //prints the data within each node
  void printHeight(AVLNode* &root); //prints the height of each node
  int checkHeight(AVLNode* &root); //checks the height of each node
